...
import { PoseAT_load_lib, HandsAT_load_lib, create_mediapipe_hand_landmarker } from './tracking/mocap-mediapipe-bridge.js?v=20260321-3';
import { PoseAT_process_video_buffer, HandsAT_process_video_buffer } from './tracking/mocap-video-processor.js?v=20260321-3';

const is_worker = (typeof window !== "object");
const TRACKING_MODULE_CACHE_BUST = '20260321-3';
