...
//return `https://cdn.jsdelivr.net/npm/@mediapipe/holistic/${file}`;
    ...
    holistic.setOptions({
modelComplexity: (S.pose_model_quality == 'Best') ? 2 : 1,
...
{
  baseOptions: {
    modelAssetPath: S.path_adjusted('@mediapipe/tasks/' + 'pose_landmarker_' + ((S.pose_model_quality == 'Best') ? 'heavy' : 'full') + '.task'),
    delegate: "GPU"
  },
  runningMode: 'VIDEO',
